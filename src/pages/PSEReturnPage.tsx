...
const statusConfig = {
  loading: {
    ...
    description: 'Estamos confirmando el estado de tu transacción con el banco.',
  },
  success: {
    icon: CheckCircle2,
    color: 'text-[#22C55E]',
  ...
  failed: {
    ...
    description: 'Lo sentimos, tu pago no pudo ser procesado. Por favor intenta nuevamente.',
  },
  error: {
    icon: XCircle,
    color: 'text-[#EF4444]',
    ...
    description: 'No pudimos verificar el estado de tu pago. Por favor contacta soporte.',
  },
};
  ...
  useEffect(() => {
    async function checkDonationStatus() {
      ...
      try {
        ...
        setStatus('error');
        setErrorMessage((err as { message?: string })?.message || 'Error al verificar pago');
      }
    }
      ...
      <div className="container mx-auto px-4 max-w-2xl">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div className="border-l border-[#E5E7EB] pl-3 ml-1">
            <p className="text-sm text-[#6B7280]">Confirmación de pago PSE</p>
          </div>
        </div>
